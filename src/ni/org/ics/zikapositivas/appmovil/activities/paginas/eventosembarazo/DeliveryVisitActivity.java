...
import ni.org.ics.zikapositivas.appmovil.adapters.eventosembarazo.DeliveryVisitAdapter;
...
public class DeliveryVisitActivity extends AbstractAsyncActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		menu_maternal_info = getResources().getStringArray(R.array.menu_maternal_delivery);
	...
	// ***************************************
		...
		private class FetchDataVisitaPartoTask extends AsyncTask<String, Void, String> {
			...
			protected void onPostExecute(String resultado) {
				...
				gridView.setAdapter(new DeliveryVisitAdapter(getApplicationContext(), R.layout.menu_item_2, menu_maternal_info, 
